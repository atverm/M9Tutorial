...
The compiler's [release page](https://github.com/atverm/m9c/releases/tag/v0.6.0)
...
gcc is the only compiler any of them needs.  For Ubuntu 24.04:
    ...
    sudo apt install ./m9_0.6.0-1_amd64.ubuntu24.04.deb

(`dnf install ./m9-0.6.0-1.fc43.x86_64.rpm`, `./m9-0.6.0-1.el9.x86_64.rpm`,
`pacman -U ./m9-0.6.0-1-x86_64.pkg.tar.zst` for the others; chapter 0
