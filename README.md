...
The compiler's [release page](https://github.com/atverm/m9c/releases/tag/v0.4.1)
...
(`dnf install ./m9-0.4.1-1.fc43.x86_64.rpm`, `./m9-0.4.1-1.el9.x86_64.rpm`,
`pacman -U ./m9-0.4.1-1-x86_64.pkg.tar.zst` for the others; chapter 0
