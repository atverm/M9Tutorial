...
BEGIN
  ...
  Io.WriteI64 (valid) ;
  Io.WriteLine (' (of ' + Fmt.I64Str (n) + ' in the store)') ;
  Io.WriteLine ('mean 2021.5        ' +
                Fmt.Fixed (coef [0], 2) + ' umol/mol') ;
  Io.WriteLine ('trend              ' +
                Fmt.Fixed (coef [1], 3) + ' umol/mol per year') ;
  Io.WriteLine ('annual amplitude   ' +
                Fmt.Fixed (amp1, 2) + ' (peak to trough ' +
                Fmt.Fixed (2.0 * amp1, 2) + ')') ;
